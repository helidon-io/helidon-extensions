...
# Imperative JMS javax messaging
...
See [JmsService.java](src/main/java/io/helidon/extensions/messaging/jms/javax/examples/imperative/JmsService.java)
...
```shell
mvn clean package
java -jar target/helidon-extensions-messaging-jms-javax-examples-se-imperative.jar
```
