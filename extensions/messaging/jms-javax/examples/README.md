...
# JMS javax messaging examples

Both examples send an HTTP request body through the `http-messages` JMS queue
...
Each example includes a local JMS Compose configuration and a real-broker
...
serially because they start JMS containers.
