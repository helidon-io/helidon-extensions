...
import io.helidon.extensions.messaging.connectors.jms.javax.JmsOutgoingConfig;
    ...
    void separatesReconnectRetryMetricsByChannelAndDirection() {
        ...
        try (ActiveMQConnectionFactory connectionFactory = new ActiveMQConnectionFactory("tcp://localhost:61616")) {
            JmsConnector connector = JmsConnector.builder()
                    ...
                    .destination("events")
                    .build();
            try (IncomingChannel _ = connector.incoming(JmsIncomingConfig.builder()
                                                                             .connector("test-jms")
                                                                             .channelName("orders")
                                                                             .build());
                    IncomingChannel _ = connector.incoming(JmsIncomingConfig.builder()
                                                                               .connector("test-jms")
                                                                               .channelName("audit")
                                                                               .build());
                    OutgoingChannel _ = connector.outgoing(JmsOutgoingConfig.builder()
                                                                                .connector("test-jms")
                                                                                .channelName("orders")
                                                                                .build());
                    OutgoingChannel _ = connector.outgoing(JmsOutgoingConfig.builder()
