...
class JmsModuleDiscoveryIT {
    ...
    void connectorMetadataIsDiscoveredFromNamedModules() {
        ...
        assertThat(testModule.getName(), is("io.helidon.extensions.messaging.tests.jms.javax"));
        assertThat("JMS connector module", connectorModule.isNamed(), is(true));
        assertThat(connectorModule.getName(), is("io.helidon.extensions.messaging.connectors.jms.javax"));
