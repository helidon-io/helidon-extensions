...
<!--@include config/io.helidon.extensions.langchain4j.ContentRetrieverConfig.md#configuration-options delim=--- offset=1 collapseTables=10 -->
...
<!--@include config/io.helidon.extensions.langchain4j.InMemoryEmbeddingStoreConfig.md#configuration-options delim=--- offset=1 collapseTables=10 -->
...
<!-- TODO
[io-helidon-integ]: ../../../config/io.helidon.extensions.langchain4j.ContentRetrieverConfig.md#configuration-options
[io-helidon-integ-2]: ../../../config/io.helidon.extensions.langchain4j.InMemoryEmbeddingStoreConfig.md#configuration-options
-->
