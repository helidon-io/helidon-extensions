...
<!--@include config/io.helidon.extensions.langchain4j.providers.mock.MockChatModel.md#configuration-options delim=--- offset=1 collapseTables=10 -->
...
<!-- TODO
[io-helidon-integ]: ../../../config/io.helidon.extensions.langchain4j.providers.mock.MockChatModel.md#configuration-options
-->
