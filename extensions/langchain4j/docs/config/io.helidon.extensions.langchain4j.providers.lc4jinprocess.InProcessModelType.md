# io.<wbr>helidon.<wbr>extensions.<wbr>langchain4j.<wbr>providers.<wbr>lc4jinprocess.<wbr>InProcess<wbr>Model<wbr>Type
...
- <a href="io.helidon.extensions.langchain4j.providers.lc4jinprocess.InProcessEmbeddingModelConfig.md#type"><code>langchain4j.<wbr>providers.<wbr>lc4j-<wbr>in-process.<wbr>type</code></a>
