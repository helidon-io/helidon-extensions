# io.<wbr>helidon.<wbr>extensions.<wbr>langchain4j.<wbr>providers.<wbr>oracle.<wbr>IvfIndex<wbr>Config
...
- <a href="io.helidon.extensions.langchain4j.providers.oracle.OracleEmbeddingStoreConfig.md#ivf-index"><code>langchain4j.<wbr>providers.<wbr>oracle.<wbr>ivf-<wbr>index</code></a>
